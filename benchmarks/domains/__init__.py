...
from benchmarks.domains.regression.direct_arylation_tl_regr import (
    direct_arylation_tl_regression_benchmark,
)
from benchmarks.domains.regression.transfer_learning_regression import (
    transfer_learning_regression_benchmark,
)
