"""Aryl halide benchmarks for transfer learning.
...
aryl_halide_sou_CT_benchmark_config = ConvergenceBenchmarkSettings(
    batch_size_settings={
        RunMode.DEFAULT: 2,
        RunMode.SMOKETEST: 2,
    },
...
aryl_halide_IP_CP_tl_benchmark_config = ConvergenceBenchmarkSettings(
    batch_size_settings={
        RunMode.DEFAULT: 2,
        RunMode.SMOKETEST: 2,
    },
...
aryl_halide_CT_I_BM_tl_benchmark = ConvergenceBenchmark(
    ...
    settings=aryl_halide_sou_CT_benchmark_config,
)
...
aryl_halide_IP_CP_tl_benchmark = ConvergenceBenchmark(
    ...
    settings=aryl_halide_IP_CP_tl_benchmark_config,
)
