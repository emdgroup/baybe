...
def easom_tl_71_noise5(settings: ConvergenceBenchmarkSettings) -> pd.DataFrame:
...
easom_tl_71_noise5_benchmark = ConvergenceBenchmark(
    function=easom_tl_71_noise5,
    optimal_target_values={"Target": -0.7836049207824949},
