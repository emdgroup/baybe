...
def quadratic_diff_min_many_sources_tl(
    settings: ConvergenceBenchmarkSettings,
) -> pd.DataFrame:
    """Benchmark function for transfer learning with different minimum and many sources.
...
optimal_value = get_optimal_target_value(n_sources=10, keep_min=False)

# Create the benchmark
quadratic_diff_min_many_sources_tl_benchmark = ConvergenceBenchmark(
    function=quadratic_diff_min_many_sources_tl,
