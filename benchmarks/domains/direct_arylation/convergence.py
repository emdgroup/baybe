"""Direct arylation reaction benchmarks (non-transfer learning)."""
...
direct_arylation_multi_batch_benchmark_config = ConvergenceBenchmarkSettings(
    batch_size_settings={
        RunMode.DEFAULT: 3,
        RunMode.SMOKETEST: 2,
    },
...
direct_arylation_single_batch_benchmark_config = ConvergenceBenchmarkSettings(
    batch_size_settings={
        RunMode.DEFAULT: 1,
        RunMode.SMOKETEST: 1,
    },
...
direct_arylation_multi_batch_benchmark = ConvergenceBenchmark(
    function=direct_arylation_multi_batch,
    optimal_target_values={"yield": 100},
    settings=direct_arylation_multi_batch_benchmark_config,
)

direct_arylation_single_batch_benchmark = ConvergenceBenchmark(
    function=direct_arylation_single_batch,
    optimal_target_values={"yield": 100},
    settings=direct_arylation_single_batch_benchmark_config,
)
