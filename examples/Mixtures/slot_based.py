...
# Modelling a mixture is possible on a non-traditional way with something we refer to as
...
# Create the parameters for the slot labels. Each of our slots offers a choice between
# 4 solvents.
...
# Create the parameters for the slot amounts.
