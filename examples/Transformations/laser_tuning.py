...
# <components/transformations:Composite Transformations>`, the optimization objective can
...
# equivalent <components/transformations:Equality>` to that of the corresponding
# algebraic construction. See our [transformation user
# guide](/components/transformations) for more alternative construction routes.
