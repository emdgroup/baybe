...
For more details, see [the detailed information on targets](docs/concepts/targets.md).
...
[the detailed information about parameters](docs/concepts/parameters).
...
Details can be found in [the detailed file about constraits](docs/concepts/constraints).
...
[the detailed information on strategies](docs/concepts/strategy).
