...
def simulate_scenarios(
    ...
    *,
    ...
    A wrapper function around :func:`baybe.simulation.core.simulate_campaign` that
    ...
    Args:
        ...
        lookup: See :func:`baybe.simulation.core.simulate_campaign`.
        batch_quantity: See :func:`baybe.simulation.core.simulate_campaign`.
        n_doe_iterations: See :func:`baybe.simulation.core.simulate_campaign`.
        ...
        impute_mode: See :func:`baybe.simulation.core.simulate_campaign`.
        noise_percent: See :func:`baybe.simulation.core.simulate_campaign`.

    Returns:
        A dataframe like returned from :func:`baybe.simulation.core.simulate_campaign`
...
def _simulate_groupby(
    ...
    *,
    ...
    A wrapper around :func:`baybe.simulation.core.simulate_campaign` that allows to
    ...
    Args:
        ...
        batch_quantity: See :func:`baybe.simulation.core.simulate_campaign`.
        n_doe_iterations: See :func:`baybe.simulation.core.simulate_campaign`.
        initial_data: See :func:`baybe.simulation.core.simulate_campaign`.
        groupby: See :func:`baybe.simulation.core.simulate_scenarios`.
        random_seed: See :func:`baybe.simulation.core.simulate_campaign`.
        impute_mode: See :func:`baybe.simulation.core.simulate_campaign`.
        noise_percent: See :func:`baybe.simulation.core.simulate_campaign`.
