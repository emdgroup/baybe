...
def register_hook(target: Callable, hook: Callable) -> Callable:
    """Register a callable for the given target method.

    Args:
        target: The method to be changed.
        hook: The callable to be registered in the given method.

    Returns:
        A wrapped callable that replaces the original target method.
