...
class GaussianProcessSurrogate(Surrogate):
    ...
    def _resolve_kernel(
        ...
        Args:
            ...
            train_x: The training input tensor.
            train_y: The training target tensor.
        ...
        if (
            ...
            kernel = self.kernel_factory(searchspace, train_x, train_y)
        ...
        reduced_searchspace = searchspace._without_task_parameter()

        try:
            base_kernel = self.kernel_factory(reduced_searchspace, train_x, train_y)
            ...
            raise IncompatibleKernelError(
                ...
                f"provided kernel factory '{type(self.kernel_factory).__name__}' "
    ...
    def _fit(self, train_x: Tensor, train_y: Tensor) -> None:
        ...
        ### Kernel
        kernel = self._resolve_kernel(context, train_x, train_y)
