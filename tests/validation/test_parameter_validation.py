...
@pytest.mark.parametrize(
    ...
    [
        ...
        param({"alphabet": {""}}, ValueError, id="element_too_short"),
        param({"alphabet": {1}}, TypeError, id="nonstring_element"),
        param({"encoder": object()}, TypeError, id="non_encoder_object"),
        param({"min_length": ""}, TypeError, id="non_int_min_length"),
        param({"max_length": ""}, TypeError, id="non_int_max_length"),
        param({"min_length": 0}, ValueError, id="min_length_zero"),
