...
def test_sampling_methods_for_cardinality_constraint():
    """
    Random samples generated under a cardinality constraint have the expected number
    of nonzeros.
    """  # noqa
    # Settings
    N_PARAMETERS = 5
...
def test_cardinality_with_linear_constraints():
