...
def clamping_transformations(draw: st.DrawFn) -> ClampingTransformation:
    """Generate :class:`baybe.targets.transformation.ClampingTransformation`."""
...
def affine_transformations(draw: st.DrawFn) -> AffineTransformation:  # type: ignore[return]
    """Generate :class:`baybe.targets.transformation.AffineTransformation`."""
...
def two_sided_linear_transformations(draw: st.DrawFn) -> TwoSidedLinearTransformation:
    """Generate :class:`baybe.targets.transformation.TwoSidedLinearTransformation`."""
...
def bell_transformations(draw: st.DrawFn) -> BellTransformation:
    """Generate :class:`baybe.targets.transformation.BellTransformation`."""
    center = draw(finite_floats())
...
def triangular_transformations(draw: st.DrawFn) -> TriangularTransformation:  # type: ignore[return]
    """Generate :class:`baybe.targets.transformation.TriangularTransformation`."""
...
def power_transformations(draw: st.DrawFn) -> PowerTransformation:
    """Generate :class:`baybe.targets.transformation.PowerTransformation`."""
    exponent = draw(finite_floats())
...
def chained_transformations(
    ...
    """Generate :class:`baybe.targets.transformation.ChainedTransformation`."""
