"""Tests for subspace-generating constraints in hybrid search spaces."""
...
def test_subspace_constraints_hybrid(constraints):
    """Subspace-generating constraints are respected in hybrid search spaces."""
