...
from baybe.parameters import TaskParameter, NumericalContinuousParameter
    ...
    campaign = deepcopy(Campaign(
        ...
        recommender=TwoPhaseMetaRecommender(
            recommender=BotorchRecommender(
                surrogate_model=GaussianProcessSurrogate(task_stratified_outtransform=task_stratified_outtransform)),
